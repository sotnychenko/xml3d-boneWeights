...
HumanSkeleton::HumanSkeleton()
{
	...
	makeJoint("spine",           Vector3(0., 0.06, 0.),      "shoulders");       //1
    makeJoint("hips",            Vector3(0., 0., 0.),        "spine");           //2
	makeJoint("neck",            Vector3(0., 0.55, 0.),      "shoulders");       //3
    makeJoint("head",            Vector3(0., 0.7, 0.),       "neck");            //4
    
    makeJoint("lthigh",          Vector3(-0.1, 0., 0.),      "hips");            //5
    makeJoint("lknee",           Vector3(-0.15, -0.35, 0.),  "lthigh");          //6
    makeJoint("lankle",          Vector3(-0.15, -0.8, 0.),   "lknee");           //7
    makeJoint("lfoot",           Vector3(-0.15, -0.8, 0.1),  "lankle");          //8
    
    makeJoint("rthigh",          Vector3(0.1, 0., 0.),       "hips");            //9
    makeJoint("rknee",           Vector3(0.15, -0.35, 0.),   "rthigh");          //10
    makeJoint("rankle",          Vector3(0.15, -0.8, 0.),   "rknee");            //11
    makeJoint("rfoot",           Vector3(0.15, -0.8, 0.1),   "rankle");          //12
    
    makeJoint("lshoulder",       Vector3(-0.2, 0.5, 0.),     "shoulders");       //13
    makeJoint("lelbow",          Vector3(-0.4, 0.25, 0.075), "lshoulder");       //14
	makeJoint("lwrist",          Vector3(-0.58, 0.1, 0.06),     "lelbow");         //15
    makeJoint("lhand",           Vector3(-0.6, 0.0, 0.0),   "lwrist");          //16
    
    makeJoint("rshoulder",       Vector3(0.2, 0.5, 0.),      "shoulders");       //17
    makeJoint("relbow",          Vector3(0.4, 0.25, 0.075),  "rshoulder");       //18
    makeJoint("rwrist",          Vector3(0.58, 0.1, 0.06),     "relbow");          //19
	makeJoint("rhand",           Vector3(0.6, 0.0, 0.0),   "rwrist");           //20
